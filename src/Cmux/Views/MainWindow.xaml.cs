...
public partial class MainWindow : Window
{
    ...
    private List<PaletteItem> BuildPaletteItems()
    {
        ...
        [
            ...
            new() { Id = "rename-workspace", Label = "Rename Workspace", Icon = "\uE8AC", Shortcut = "Ctrl+Shift+R", Category = "Workspace", Execute = () => ViewModel.SelectedWorkspace?.Rename() },
            new() { Id = "jump-unread", Label = "Jump to Latest Unread Notification", Icon = "\uEA8F", Shortcut = "Ctrl+Shift+U", Category = "View", Execute = () => ViewModel.JumpToLatestUnread() },
            new() { Id = "toggle-broadcast", Label = "Toggle Broadcast Input Bar", Icon = "\uE95A", Shortcut = "Ctrl+Shift+B", Category = "View", Execute = () => ViewModel.BroadcastInput.Toggle() },
            new() { Id = "edit-ssh-config", Label = "Edit ~/.ssh/config", Icon = "\uE713", Shortcut = "Ctrl+Shift+S", Category = "App", Execute = OpenSshConfigInEditor },
